...
abline(v = mean(totalSteps$steps),lty = 1, lwd = 2, col = "dodgerblue")
abline(v = median(totalSteps$steps),lty = 2, lwd = 3, col = "lightskyblue1")

legend(x = "topright", c("Mean", "Median"), col = c("dodgerblue", "lightskyblue1"),
       lty = c(1, 2), lwd = c(2, 3))
...
abline(v = mean(totalSteps.clean$steps),lty = 1, lwd = 2, col = "dodgerblue")
abline(v = median(totalSteps.clean$steps),lty = 2, lwd = 3, col = "lightskyblue1")
